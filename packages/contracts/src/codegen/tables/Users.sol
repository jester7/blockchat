...
library Users {
  ...
  /** Get username */
  function get(bytes32 key) internal view returns (string memory username) {
  ...
  function get(IStore _store, bytes32 key) internal view returns (string memory username) {
    bytes32[] memory _keyTuple = new bytes32[](1);
    _keyTuple[0] = bytes32((key));
  ...
  /** Set username */
  function set(bytes32 key, string memory username) internal {
    bytes32[] memory _keyTuple = new bytes32[](1);
    _keyTuple[0] = bytes32((key));
  ...
  function set(IStore _store, bytes32 key, string memory username) internal {
    bytes32[] memory _keyTuple = new bytes32[](1);
    _keyTuple[0] = bytes32((key));
